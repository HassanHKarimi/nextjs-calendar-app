    ...
    >
      <div className="relative w-full max-w-md rounded-lg bg-white/90 dark:bg-gray-900/90 p-6 shadow-xl border border-gray-200 dark:border-gray-700 backdrop-filter backdrop-blur-md before:content-[''] before:absolute before:inset-0 before:bg-noise-pattern before:opacity-5 before:mix-blend-overlay">
        ...
        {!eventData.hasValidDates && (
          <div className="mt-4 bg-yellow-50 border-l-4 border-yellow-400 p-3 dark:bg-yellow-900/50 dark:border-yellow-600">
            <div className="flex">
              <div className="ml-3">
        ...
        <div className="mt-8 flex justify-end space-x-3">
          <button
            onClick={onClose}
            className="rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
          >
            Close
          </button>
          <button
            ...
            className="rounded-md bg-gray-700 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800 dark:bg-gray-600 dark:hover:bg-gray-700"
          >
            Edit
          </button>
        </div>
